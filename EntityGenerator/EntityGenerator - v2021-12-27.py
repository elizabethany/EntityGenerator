...
def generatePortalSpawnTarget(
    ...
    args = {
        ...
        'mat2ZEmit' : emitOrientation[8],
        'yawSpawn' : yawSpawn,
        'mat0XSpawn' : spawnOrientation[0],
        'mat0YSpawn' : spawnOrientation[1],
        'mat0ZSpawn' : spawnOrientation[2],
        'mat1XSpawn' : spawnOrientation[3],
        'mat1YSpawn' : spawnOrientation[4],
        'mat1ZSpawn' : spawnOrientation[5],
        'mat2XSpawn' : spawnOrientation[6],
        'mat2YSpawn' : spawnOrientation[7],
        'mat2ZSpawn' : spawnOrientation[8]
    }
...
# Function to calculate side lengths based on given angle (yaw) and known hypotenuse (1 * distanceScale)
def hypotReverse(yaw):
...
if entityType == 1:
    ...
    entityNameNumber = int(input("\nSet entity numbering start value: ")); # # Set number to append at end of entity name
    while True:
        generatePortalSpawnTarget(entityNameNumber, PortalSpawnTargetTemplate, output1)
